...
# -*- coding: utf-8 -*-
"""
[AI-2] Aircon_offON_Prediction_260207.py
건물 에어컨 ON/OFF 이진분류 예측 모델 (LightGBM)
"""
...
pio.renderers.default = 'browser'  # 또는 None으로 설정하여 자동 종료
...
# ============================================================
# 5. Save the model & Run Inference
# ============================================================
