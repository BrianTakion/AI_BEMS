...
# ============================================================
file_path_AI_model = os.path.join(script_dir, f"{devID}_{device_name}_MainPower_Prediction_LGBM.txt")
...
start_date_peak, end_date_peak = '2025-09-02', '2025-09-09'
df_period = df_interpol[(df_interpol.index >= start_date_peak) & (df_interpol.index <= end_date_peak)].copy()
...
Util.plot_peak_time_distribution(peak_time_freq, peak_time_max_values, start_date_peak, end_date_peak)

print(daily_peak_info)
