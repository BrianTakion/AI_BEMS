...
# -*- coding: utf-8 -*-
"""
[AI-1] MainPower_Prediction_train_260207.py
건물 에너지 데이터를 활용한 LightGBM 기반 전력 예측 모델 - 학습용
"""
...
# CLI Arguments
# ============================================================
parser = argparse.ArgumentParser(description='LightGBM 기반 전력 예측 모델 - 학습용')
...
# ============================================================
# 3. Feature Engineering & LightGBM Training
# ============================================================
...
html_path = os.path.join(script_dir, 'train_result.html')
